...
const Footer = () => {
    return (
        <div className="bg-gray-200 shadow-xl rounded-md">
            <footer className="px-4 py-8 dark:bg-gray-800 dark:text-gray-400">
                <div className="container md:flex flex-wrap items-center justify-center mx-auto space-y-4 sm:justify-between sm:space-y-0">
